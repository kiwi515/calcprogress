...
def calc_module_progress(module: Module, asm_list: list[AsmUtil.Section], callback: "function"):
    """Calculate decompilation progress of the specified module (DOL/REL).
